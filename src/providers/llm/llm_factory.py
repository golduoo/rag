...
from src.providers.llm.base_llm import BaseLLM
from src.providers.llm.base_vision_llm import BaseVisionLLM
...
def _register_vision_providers() -> None:
    ...
    """
    try:
        from src.providers.llm.azure_vision_llm import AzureVisionLLM
    ...
    try:
        from src.providers.llm.openai_vision_llm import OpenAIVisionLLM
        from src.providers.llm.llm_factory import LLMFactory
