...
from src.response.response_builder import ResponseBuilder, MCPToolResponse
from src.core.settings import load_settings, resolve_path, Settings
from src.observability.trace import TraceContext, TraceCollector
...
class QueryKnowledgeHubTool:
    ...
    def _ensure_initialized(self, collection: str) -> None:
        ...
        from src.retrieval.reranker import create_core_reranker
        from src.ingestion.storage.bm25_indexer import BM25Indexer
        from src.providers.embedding.embedding_factory import EmbeddingFactory
        from src.providers.vector_store.vector_store_factory import VectorStoreFactory
