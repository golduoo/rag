...
class TestCreateDenseRetriever:
    ...
    @patch('src.providers.vector_store.vector_store_factory.VectorStoreFactory.create')
    @patch('src.providers.embedding.embedding_factory.EmbeddingFactory.create')
