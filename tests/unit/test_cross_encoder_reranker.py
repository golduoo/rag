...
from src.providers.reranker.cross_encoder_reranker import (
...
class TestCrossEncoderRerankerInit:
    ...
    @patch('src.providers.reranker.cross_encoder_reranker.CrossEncoderReranker._load_cross_encoder_model')
