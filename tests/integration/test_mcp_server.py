...
def test_multimodal_assembler_image_content_structure() -> None:
    ...
    from src.response.multimodal_assembler import MultimodalAssembler
...
def test_mcp_tool_response_image_content_format() -> None:
    ...
    from src.response.citation_generator import Citation
    from src.response.response_builder import MCPToolResponse
